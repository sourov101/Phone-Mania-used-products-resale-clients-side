...
const Stories = () => {
    ...
    return (
        ...
        <div>
            <h1 className='text-3xl mt-10 text-center'>Popular Stories</h1>
            <div className='grid my-10 gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mx-auto '>
                {
                    stories.map(story =>
                        <div key={story.id} className="card  bg-base-100 shadow-xl">
                            <figure><img className='w-1/2' src={story.image} alt="Shoes" /></figure>
